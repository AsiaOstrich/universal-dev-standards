  ...
  en: {
    ...
    commands: {
      ...
      check: {
        ...
        modified: 'modified',
        missing: 'missing',
        retired: 'no longer shipped by UDS',
        retiredHeader: '{count} tracked file(s) are gone because UDS stopped shipping them. That is the migration completed, not a fault:',
        retiredHint: 'Run `uds update` to drop their manifest records. `--restore` cannot bring them back — there is no source upstream.',
        ...
        standardsNotReferenced: 'Standards with no "Reference:"/"參考:" line in this file (optional):',
        ...
        brokenMentions: 'mentions paths that do not exist in this project:',
        brokenMentionsFix: 'These are usually outside the UDS block, left by an older install. UDS does not rewrite text it did not write — correct them by hand or delete the line.',
  ...
  'zh-tw': {
    ...
    commands: {
      ...
      check: {
        ...
        missing: '遺失',
        retired: 'UDS 已不再出貨',
        retiredHeader: '有 {count} 個被追蹤的檔案不見了，原因是 UDS 已不再出貨。那是遷移完成的樣子，不是故障：',
        retiredHint: '執行 `uds update` 清掉它們在 manifest 的紀錄。`--restore` 救不回來——上游已經沒有來源。',
        ...
        standardsNotReferenced: '本檔案中沒有「Reference:」或「參考:」行提及的標準（選用）：',
        ...
        brokenMentions: '提到了本專案裡不存在的路徑：',
        brokenMentionsFix: '這些通常在 UDS 區塊之外，是舊版安裝留下的。UDS 不會改寫不是它寫的文字——請手動更正或刪掉那一行。',
  ...
  'zh-cn': {
    ...
    commands: {
      ...
      check: {
        ...
        missing: '缺失',
        retired: 'UDS 已不再发布',
        retiredHeader: '有 {count} 个被追踪的文件不见了，原因是 UDS 已不再发布。那是迁移完成的样子，不是故障：',
        retiredHint: '执行 `uds update` 清掉它们在 manifest 的记录。`--restore` 救不回来——上游已经没有来源。',
        existsNoHash: '存在，无哈希',
        ...
        standardsNotReferenced: '本文件中没有"Reference:"或"參考:"行提及的标准（可选）：',
        ...
        brokenMentions: '提到了本项目里不存在的路径：',
        brokenMentionsFix: '这些通常在 UDS 区块之外，是旧版安装留下的。UDS 不会改写不是它写的文字——请手动更正或删掉那一行。',
