...
> Auto-generated by `scripts/generate-locale-coverage.mjs` on 2026-06-18.
> Do not edit manually — re-run the script.

> **Canonical**: `skills/` (55) + `core/` (145). **Locales tracked**: `zh-CN`, `zh-TW`.
...
| logging-standards.md | :white_check_mark: 1.3.0 | :white_check_mark: 1.4.0 |
...
**zh-CN core coverage**: 128/145 (88%)
**zh-TW core coverage**: 145/145 (100%)
