...
**规则**: 当专案整合了 SDD 工具（如 OpenSpec, Spec Kit 等）且该工具提供特定命令（例如 `/openspec` 或 `/spec` 等斜线命令）时，AI 助手**必须优先使用这些命令**，而非直接手动编辑档案。
...
**规则**: 在没有经核准的规格或变更提案的情况下，不得进行功能性的程式码变更。
...
- [测试驱动开发](test-driven-development.md) - TDD 工作流程与 SDD 整合
...
- [程式码签入标准](../../../core/checkin-standards.md) - 程式码签入标准
- [程式码审查清单](../../../core/code-review-checklist.md) - 程式码审查清单
...
| 1.1.0 | 2025-12-24 | 新增：工作流程图、规格范本、整合指南、最佳实践、相关标准、授权 |
