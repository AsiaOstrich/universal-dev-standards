...
**标准一致性：**
- [ ] `core/` ↔ `ai/standards/` - AI 优化版本与核心标准一致
- [ ] `options/` ↔ `ai/options/` - 每个选项都有人类可读（.md）和 AI 优化（.ai.yaml）版本
- [ ] 验证选项类别一致：git-workflow, commit-message, testing, project-structure, changelog, code-review, documentation
