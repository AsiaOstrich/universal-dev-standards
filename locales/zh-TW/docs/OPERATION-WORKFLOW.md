...
步驟 3：建立輔助指南檔案
        ↓
步驟 4：更新安裝腳本（install.sh, install.ps1）
        ↓
步驟 5：在 locales/ 中建立翻譯
        ↓
步驟 6：更新文件（README.md 等）
        ↓
步驟 7：執行驗證腳本
```
...
```
步驟 1：建立 integrations/[tool-name]/ 目錄
        ↓
步驟 2：建立含安裝指南的 README.md
        ↓
步驟 3：建立工具特定配置檔案
        ↓
步驟 4：更新 integration-generator.js（如需動態生成）
        ↓
步驟 5：建立翻譯（選用）
        ↓
步驟 6：更新文件
