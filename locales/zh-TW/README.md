...
**版本**: 5.0.0-rc.1 (Pre-release) | **發布日期**: 2026-02-13 | **授權**: [雙重授權](../../LICENSE) (CC BY 4.0 + MIT)
...
| 類別 | 數量 | 說明 |
| :--- | :--- | :--- |
| **核心標準** | 32 | 通用開發準則（TDD, BDD, 安全性, 效能等） |
| **AI Skills** | 27 | 適用於 Claude Code, OpenCode 等工具的互動式技能 |
| **斜線命令** | 30 | 快速操作（例如 `/tdd`, `/review`, `/derive`） |
