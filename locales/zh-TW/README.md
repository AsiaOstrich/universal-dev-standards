...
UDS 保持**工具無關性**：支援 Claude Code、OpenCode、Gemini CLI、Cursor、Cline、Roo Code、Windsurf、GitHub Copilot、OpenAI Codex、Aider、Continue 和 Google Antigravity。DevAP 和 VibeOps 是消費者，並非必要依賴。
